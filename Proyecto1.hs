...
--ghci> sumatoria'' [3,12,4,6] (id)
--25
--ghci> sumatoria'' [3,12,4,6] (+1)
--29

productoria'' :: [a] -> (a -> Int) -> Int
productoria'' xs t = cuantGen (*) (1) xs t

--ghci> productoria'' [5,6,7] (*2)
--1680
--ghci> productoria'' [5,6,7] (+1)
--336
...
--ghci> distanciaEdicion "Hola" "Hola mundo"
--6
--ghci> distanciaEdicion "buen" "buen dia"
--4
...
--ghci> primQueCumplen [2,4,8,9,7] (even)
--[2,4,8]
--ghci> primQueCumplen "aeropuerto" (esVocal)
--"ae"
